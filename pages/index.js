...
function inicialPage(){
  return (
    <>
      ...
      <p> Nós da Insper Jr. somos uma empresa de consultoria formada exclusivamente por alunos do Insper, sem fins lucrativos, que visa impactar a sociedade por meio da superação de desafios.
      ...
      Para 2022 queremos atingir patamares cada vez maiores. Venha fazer parte do processo seletivo! </p>
        ...
        <div className="conteudo">
          ...
          <h1>As datas de cada fase e uma melhor descrição estão no nosso edital:</h1>
          <Edital />
